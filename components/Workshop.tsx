export default function Workshop() {
  return (
    <section id="workshop" className="py-24 px-4 sm:px-6 lg:px-8 bg-primary text-white">
      <div className="max-w-4xl mx-auto text-center">
        <span className="text-xs font-semibold tracking-widest uppercase text-white/40 block mb-4">
          Workshop
        </span>
